...
ipcwqrPIC::picrq(L,R,delta,x=x,tau=tau,hlimit=0.9)
ipcwqrPIC::picrq(L,R,delta,x=x,tau=tau,estimation = "dr")
ipcwqrPIC::picrq(L,R,delta,x=x,tau=tau,id=id)
ipcwqrPIC::picrq(L,R,delta,x=x,tau=tau,id=id,index = 2,wttype = "nonparam",hlimit=0.99)
```
