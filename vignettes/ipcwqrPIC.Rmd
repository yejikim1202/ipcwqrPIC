...
ipcwqrPIC::dcrq(L=L,R=R,T=T,delta=delta,x=x,tau=tau,wttype="KM",var.estimation="Bootstrap",id=id,index = 1)
```
...
# ipcwqrPIC::picrq(L=U,R=V,delta=delta,x=x,tau=tau,wttype="KM",application=TRUE,estimation="DR",hlimit=0.1,var.estimation = "IS",id=id,index = 1,B=100)
```
