...
tau=0.3
ipcwqrPIC::picrq(U=log(U),V=log(V),delta=delta,x=x,tau=tau,var.estimation = "IS")
ipcwqrPIC::picrq(U=log(U),V=log(V),delta=delta,x=x,tau=tau,estimation = "DR",var.estimation = "IS")
```
