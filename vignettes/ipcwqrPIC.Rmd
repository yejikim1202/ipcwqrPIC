...
ipcwqrPIC::dcrq(L=L,R=R,T=T,delta=delta,x=x,tau=tau,application=TRUE,var.estimation = "Bootstrap")
ipcwqrPIC::dcrq(L=L,R=R,T=T,delta=delta,x=x,tau=tau,estimation = "DR", var.estimation = "IS")
ipcwqrPIC::dcrq(L=L,R=R,T=T,delta=delta,x=x,tau=tau,application=TRUE,estimation = "DR", var.estimation = "Bootstrap")
...
ipcwqrPIC::dcrq(L=L,R=R,T=T,delta=delta,x=x,tau=tau,wttype="KM",application=TRUE,var.estimation="Bootstrap",id=id,index = 1)
```
