...
ipcwqrPIC::picrq(L=U,R=V,delta=delta,x=x,tau=tau,wttype="KM",hlimit=0.1,var.estimation = "IS",id=id,index = 1)
ipcwqrPIC::picrq(L=U,R=V,delta=delta,x=x,tau=tau,wttype="Ishwaran",var.estimation = "Bootstrap",id=id,index = 1,B=100)
```
