...
tau=0.3
ipcwqrPIC::picrq(U=U,V=V,delta=delta,x=x,tau=tau,var.estimation = "IS")
ipcwqrPIC::picrq(U=U,V=V,delta=delta,x=x,tau=tau,estimation = "DR",var.estimation = "IS")
```
...
ipcwqrPIC::dcrq(L,R,T,delta,x,tau,wttype = "Beran", hlimit = 0.9, var.estimation = "IS")
